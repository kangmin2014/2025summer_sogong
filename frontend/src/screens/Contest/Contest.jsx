...
export const Contest = () => {
  ...
  return (
    <div className="contest-wrapper">
      ...
      <div className="contest-external-content">
        ...
        <div className="contest-external-body">
          <FilterSection filters={filters} setFilters={setFilters} />

          <div className="contest-external-main">
            <div className="contest-item-list-wrapper-container">
