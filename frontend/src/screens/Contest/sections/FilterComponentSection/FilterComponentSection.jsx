...
export const FilterComponentSection = () => {
  ...
  return (
    <nav className="contest-nav" role="navigation" aria-label="Activity category filters">
      <Button
        variant="ghost"
      ...
      <div className="category-wrapper" role="tablist">
        {filterCategories.map((category) => (
          ...
          />
            <span className={`contest-category-label ${activeFilter === category.id ? "contest-active-label" : ""}`}>
              {category.label}
            </span>
          </Button>
        ))}
