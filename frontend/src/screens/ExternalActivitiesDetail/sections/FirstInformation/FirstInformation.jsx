...
import { TagGather } from "./TagGather";
    ...
    <div className="first-information">
      <div className="information-box">
        ...
        <div className="basic-information">
          <p className="title">제43기 신한은행 대학생 홍보대사 모집</p>

          <p className="div">
            신한은행과 함께라서 가능한 특별한 무대, 이번 여름, 세상을 바꿀 너의
            이야기를 들려줘! 가장 빛나는 주인공은 바로 너야 💙
          </p>
        </div>
        ...
        <div className="plus-information">
          <div className="div-2">
            ...
            <div className="text-wrapper-2">(4.4)</div>

            <div className="text-wrapper-2">활동 리뷰글</div>

            <div className="text-wrapper-2">2,930개</div>
          </div>
          ...
          <div className="div-2">
            ...
            <div className="text-wrapper-3">주식회사 신한은행</div>
          </div>
          ...
          <div className="tag-information">
            ...
            <TagGather className="tag-gather-instance" />
          </div>
        </div>
      </div>
